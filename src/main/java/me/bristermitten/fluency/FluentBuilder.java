 ...
 * rather than storing the values and then creating a new object. Because of this, it is not recommended to build an immutable type
 * <p>
 ...
 * To accurately identify if a builder has a parent or not, assume it to be null unless the builder was obtained
