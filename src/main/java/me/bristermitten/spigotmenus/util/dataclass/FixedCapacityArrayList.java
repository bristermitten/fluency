 ...
 * Therefore, a FixedCapacityArrayList with size 4 might look like this ["hello", "string 2", null, null],
 ...
 */
public class FixedCapacityArrayList<E> extends ArrayList<E> {

    private final int maxCapacity;

    public FixedCapacityArrayList(int maxCapacity) {
        this.maxCapacity = maxCapacity;
        addEmptyToFill(maxCapacity);
    }

    public FixedCapacityArrayList(Collection<E> copyOf) {
        this(copyOf.size(), copyOf);
    }

    public FixedCapacityArrayList(int maxCapacity, Collection<E> copyOf) {
        this.maxCapacity = maxCapacity;
